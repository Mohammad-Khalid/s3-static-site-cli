...
const _askCredential = async (profileName) => {
    ...
    console.log('\nPlease visit https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-configure.html' +
        '\nFill in the AWS Access key ID and Secret access key below to save/modify your AWS-S3 profile.');
